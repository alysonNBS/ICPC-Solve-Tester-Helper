...
int main(int argc, char** argv) {
    char *code = ""; // set your code path
    char *language = ""; // set language your code
    char *path_input = ""; // set problem input directory path
    char *path_output = ""; // set problem output directory path
